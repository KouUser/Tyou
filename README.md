...
在 PSD 中给图层名添加特定后缀，即可自动完成九宫格切图、设置 Border、导入后自动设为 SLICED 模式并还原原始尺寸：

| 命名后缀 | 含义 | 示例 |
|---------|------|------|
| `_9s` | 标记为九宫格，insets 自动推算（短边 1/3） | `bg_panel_9s` |
| `_scale9` | 同上，另一种写法 | `btn_red_scale9` |
| `_9s_T_B_L_R` | 显式指定 insets：上_下_左_右（px） | `bg_dialog_9s_50_50_40_40` |
| `_scale9_T_B_L_R` | 同上 | `bg_dialog_scale9_50_50_40_40` |
